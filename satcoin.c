...
void verifyhash(unsigned int *block, unsigned int nonce)
{
    ...
    // assign nonce incrementally from parameter
    *u_nonce = nonce;
    ...
    // __CPROVER_assume(*u_nonce > 4043570729 && *u_nonce < 4043570732); // 2 nonces
...
unsigned int block_654000[20] = {
    ...
    0x22223332}; // randomly picked nonce which will be overwritten
...
unsigned int block_798000[20] = {
    ...
    0xbb05ab64,
    0xbe8e0517,
    // 0x60a82326}; // correct nonce
    0x22223333}; // random nonce which will be overwritten

unsigned int block_834202[20] = {
    0x0040312f,
    0x824d38dd,
    0x00bd12fe,
    0xe3ac2aba,
    ...
    0x81f3ee65,
    0x128c0317,
    // 0x01b4122b}; // correct nonce
    0x22223333}; // random nonce which will be overwritten

// currently one of the the smallest SHA256 hashes with 24 leading zeros
unsigned int block_756951[20] = {
    0x00004020,
    0x54918d67,
    0x1610fc65,
    0xc9acb5dd,
